...
exports.texCommands = {
    newcommand(ctx, vars) {
        ...
        ctx.texCommandDefs[cmdName] = function (ctx, args, tex) {
            ...
            return tex(ctx, new stream_1.StringStream(res + releaseVars(args, coveredR)));
        };
        return '';
    },
    par(ctx, vars, tex) {
        ...
        return '<br/>' + tex(ctx, new stream_1.StringStream(releaseVars(vars, 0)));
    },
    indent(ctx, vars, tex) {
        if (ctx.underMathEnv) {
            return '\\indent';
    ...
    url(ctx, vars, tex) {
        ...
        return '<a href="' + vars[0].text + '">' + vars[0].text + '</a>' +
            tex(ctx, new stream_1.StringStream(releaseVars(vars, 1)));
    },
    section(ctx, vars, tex) {
        ...
        return '<h1>' + tex(ctx, new stream_1.StringStream(vars[0].text)) + '</h1>' +
            tex(ctx, new stream_1.StringStream(releaseVars(vars, 1)));
    },
    subsection(ctx, vars, tex) {
        ...
        return '<h3>' + tex(ctx, new stream_1.StringStream(vars[0].text)) + '</h3>' +
            tex(ctx, new stream_1.StringStream(releaseVars(vars, 1)));
    },
    subsubsection(ctx, vars, tex) {
        ...
        return '<h5>' + tex(ctx, new stream_1.StringStream(vars[0].text)) + '</h5>' +
            tex(ctx, new stream_1.StringStream(releaseVars(vars, 1)));
    },
    subsubsubsection(ctx, vars, tex) {
        ...
        return '<h6>' + tex(ctx, new stream_1.StringStream(vars[0].text)) + '</h6>' +
            tex(ctx, new stream_1.StringStream(releaseVars(vars, 1)));
    }
};
